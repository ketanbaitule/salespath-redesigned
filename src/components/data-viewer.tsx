...
export function DataViewer<T extends { id: string | number }>({
  categories,
  products,
  columns,
  GridCard,
  ...
  products: T[];
  columns: ColumnDef<T>[];
  GridCard: React.ComponentType<{ product: T }>;
  ...
  // Update column filters when category filter changes
  useMemo(() => {
  ...
  // Get filtered data for both views
